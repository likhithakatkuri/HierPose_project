"""HierPose — Interpretable Multi-Domain Pose Intelligence Platform."""
import streamlit as st

st.set_page_config(
    page_title="HierPose — Interpretable Pose Intelligence",
    page_icon="🦴",
    layout="wide",
...
if not st.session_state.logged_in:
    ...
    with col_mid:
        ...
        <div style='text-align:center; padding: 2rem 0 1rem 0;'>
            <h1>🦴 HierPose Platform</h1>
            <p style='color:gray; font-size:1.1rem;'>
                Hierarchical Geometric–ML Framework for Interpretable Multi-Domain Pose Intelligence<br>
                Medical · Rehabilitation · Gait · Sports · Ergonomics · Action Recognition
            </p>
        </div>
...
# ── Home page ─────────────────────────────────────────────────────────────────
st.title("🦴 HierPose — Interpretable Multi-Domain Pose Intelligence")
...
DOMAIN_CARDS = [
    {
        ...
        "page": "pages/2_medical_rehabilitation.py",
        "color": "#1e3a5f",
    },
    {
        "key": "action",
    ...
    },
    {
        ...
        "page": "pages/4_workplace_ergonomics.py",
        "color": "#4a3a1e",
    },
    {
        "key": "medical",
        ...
        "page": "pages/7_adaptive_care_engine.py",
        "color": "#2a1a4a",
    },
]
...
st.sidebar.markdown("HierPose · MediaPipe · scikit-learn · Groq LLM · Streamlit")
